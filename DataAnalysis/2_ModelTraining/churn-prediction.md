...
- 그러나 머신러닝이 모든 것을 다 알아서 해주는 것이 아닙니다.
...
A. 일단, 3 종류 인스턴스가 생성됩니다. 노트북은 노트북 실행시, 학습용은 실행시, 엔드포인트는 엔드포인트 배포시에, 그런데 엔드포인트는 정지하지 않으면 계속 운영된다!
...
A. 자세한 문서가 많지만 [XGBoost](https://brunch.co.kr/@snobberys/137) 여기가 잘 정리해 놓은 것 같습니다.
