...
* Add filter 에서 `AMI ID:` 를 선택 하고 `ami-872d87e9` 를 입력합니다.
...
Note:
- 쉽게 찾는 링크
  - https://ap-northeast-2.console.aws.amazon.com/ec2/v2/home?region=ap-northeast-2#Images:visibility=public-images;imageId=ami-872d87e9
- AMI 에 설치된 서비스
