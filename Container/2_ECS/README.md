...
1. frontend serviceHost를 elb domain으로 수정하고 다시 배포한 다음 잘 되는지 확인해본다.
 
### CodeBuild & CodePipeline

1. maven 캐싱용 S3 버켓 만들기
    ![](./images/codebuild-cache-s3.png)

1. CodeBuild 프로젝트 만들기
...
1. CodeBuild role에  ECR 관련 권한 부여
...
1. 코드를 수정하고 푸시하고 자동으로 서비스에 반영되는지 확인해본다.

1. frontend 프로젝트와 연결해본다.
